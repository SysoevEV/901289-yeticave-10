/* заполняем категории */
INSERT INTO categories (category_name , symbol_code) VALUES ('Доски и лыжи' , 'boards'); 
INSERT INTO categories (category_name , symbol_code) VALUES ('Крепления ' , 'attachment');
INSERT INTO categories (category_name , symbol_code) VALUES ('Ботинки' , 'boots');
INSERT INTO categories (category_name , symbol_code) VALUES ('Одежда' , 'clothing');
INSERT INTO categories (category_name , symbol_code) VALUES ('Инструменты' , 'tools');
INSERT INTO categories (category_name , symbol_code) VALUES ('Разное' , 'other');
...
/* Добавляем лоты */
INSERT INTO lots ( user_id_author, user_id_winner, category_id, date_create, lot_name, description, img_ref, start_price, date_finish, bet_step ) 
...
SELECT lot_name, start_price, img_ref, category_name, price FROM lots l 
JOIN categories c ON c.id=l.category_id
LEFT JOIN bets b ON b.lot_id=l.id 
ORDER BY l.date_create

/* получить название категории лота */
SELECT l.id, category_name FROM lots l 
JOIN categories c ON l.category_id=c.id ORDER BY l.id

/*обновить название лота по его идентификатору */
UPDATE lots SET lot_name="NEW NAME" WHERE id=1;
