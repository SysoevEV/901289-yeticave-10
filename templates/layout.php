...
<head>
    ...
    <?php if (isset($is_add)): print '<link href="../css/flatpickr.min.css" rel="stylesheet">'; endif; ?>
</head>
<body>
<div class="page-wrapper">
    ...
    <?php else : ?>
        <nav class="nav">
            <ul class="nav__list container">
                <?php foreach ($categories as $i => $val) : ?>
                    <li class="nav__item">
                        <a href="search.php?search=<?= $val['name']; ?>&cat_id=<?= $val['id']; ?>"><?= htmlspecialchars($val['name']); ?></a>
                    </li>
                <?php endforeach; ?>
    ...
    <main <?php if (isset($is_index)): print 'class=container'; endif; ?>>
        <?= $content; ?>
    </main>
</div>
