...
<div class="page-wrapper">
    ...
    <header class="main-header">
       ...
       <div class="user-menu__logged">
        ...
        <a class="user-menu__bets" href="my-bets.php?id=<?=$_SESSION['user']['id'];?>">Мои ставки</a>
            ...
            <div class="lot-item__content">
                ...
                <div class="lot-item__right">
                    ...
                    <div class="lot-item__state">
                        ...
                        <div class="lot-item__timer timer <?php if($hh_mm["remain_hours"]<1) print "timer--finishing" ?>">
                        ...
                        <form class="lot-item__form" action="lot.php?id=<?=$lot_data['id']; ?>" method="post" autocomplete="off">
                            <p class="lot-item__form-item form__item <?php if($errors['cost']){print "form__item--invalid";} ?>">
