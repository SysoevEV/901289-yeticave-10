  ...
  <main>
    ...
    <form class="form form--add-lot container <?php if(count($errors) {print "form--invalid"}) ?> " action="add.php" method="post" enctype="multipart/form-data"> <!-- form--invalid -->
      ...
      <div class="form__container-two">
        <div class="form__item <?php if($errors['lot-name']){print 'form__item--invalid';} ?>" > <!-- form__item--invalid -->
        ...
        <div class="form__item  <?php if($errors['category']){print 'form__item--invalid';} ?>" >
          ...
          <select id="category" name="category">
            ...
            <?php foreach ($categories as $i => $val ) : ?>
                <option  <?php if($_SERVER['REQUEST_METHOD']=='POST' && $_POST['category']==$val['name']){ print 'selected';}?>><?=$val['name'] ?></option>
            <?php endforeach; ?>
          </select>
          <span class="form__error"><?=$errors['category'];?></span>
        </div>
      </div>
      <div class="form__item form__item--wide <?php if($errors['message']){print 'form__item--invalid';} ?>">
        <label for="message">Описание <sup>*</sup></label>
        <textarea id="message" name="message" placeholder="Напишите описание лота"><?=get_post_val('message');?></textarea>
        <span class="form__error"><?=$errors['message'];?></span>
      </div>
      <div class="form__item form__item--file  <?php if($errors['lot-img']){print 'form__item--invalid';} ?>">
